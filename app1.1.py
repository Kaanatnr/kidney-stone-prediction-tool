...
/* Help icon v5: replace Streamlit's hollow ring with a clean filled ? badge */
[data-testid="stTooltipIcon"] button,
[data-testid="stTooltipHoverTarget"] button,
button[aria-label="Help"]{
...
[data-testid="stTooltipHoverTarget"] button::after,
...
<div class="hero">
  ...
  <p style="color:#ffffff !important; -webkit-text-fill-color:#ffffff !important; opacity:1 !important;">Interactive companion to an explainable NHANES stacking-ensemble study. The app uses the supplied fitted model directly and translates technical NHANES variables into plain-language inputs.</p>
  <div class="metrics">
