...
.hero h1{margin:0 0 10px;font-size:42px;line-height:1.05;letter-spacing:-.025em}
.hero p{margin:0;opacity:.92;max-width:900px;line-height:1.6;font-size:15px}
.metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:22px}
.metric{padding:14px 16px;border:1px solid rgba(255,255,255,.2);border-radius:14px;background:rgba(255,255,255,.08)}
.metric b{display:block;font-size:22px}.metric span{font-size:11px;opacity:.78;text-transform:uppercase;letter-spacing:.06em}
...
.hero, .hero h1, .hero h2, .hero h3, .hero h4, .hero p, .hero span, .hero b{color:white !important}
.badge{color:#755500 !important}

/* ---------- cards/results ---------- */
.info-card{background:white;border:1px solid var(--line);border-radius:17px;padding:18px 20px;box-shadow:0 8px 24px rgba(22,45,72,.045);margin:10px 0}
.info-card h4{margin:0 0 5px;color:var(--navy)}
.small-note{font-size:12px;color:var(--muted);line-height:1.55}
.result-card{background:white;border:1px solid var(--line);border-radius:20px;padding:26px;box-shadow:0 12px 32px rgba(22,45,72,.08)}
.result-value{font-size:64px;font-weight:850;line-height:1;color:var(--navy);letter-spacing:-.04em}
.result-label{color:var(--muted);font-weight:650;margin-top:6px}
.scorebar{height:12px;background:#e9eef3;border-radius:999px;overflow:hidden;margin:18px 0 8px}
.scorefill{height:100%;background:linear-gradient(90deg,#1b8ca1,#156b96);border-radius:999px}
.warning{background:var(--warn);border:1px solid #ecd996;color:#69521b;border-radius:13px;padding:13px 14px;font-size:12px;line-height:1.55}
.okbox{background:#edf8f4;border:1px solid #cce9de;color:#285e50;border-radius:13px;padding:13px 14px;font-size:12px;line-height:1.55}
.process{display:grid;grid-template-columns:repeat(5,1fr);gap:8px;margin:14px 0 18px}
.process-step{background:#fff;border:1px solid var(--line);border-radius:14px;padding:13px;min-height:105px}
.process-step b{display:block;color:var(--navy);margin-bottom:5px}.process-step span{font-size:11px;color:var(--muted);line-height:1.4}

/* ---------- typography ---------- */
[data-testid="stAppViewContainer"] h1:not(.hero h1),
[data-testid="stAppViewContainer"] h2:not(.hero h2),
[data-testid="stAppViewContainer"] h3:not(.hero h3),
[data-testid="stAppViewContainer"] h4:not(.hero h4),
...
button[aria-label="Help"], button[aria-label="Help"] svg{
...
[data-testid="stButton"] button{
  ...
  border:0 !important;
  box-shadow:0 6px 16px rgba(20,93,134,.18) !important;
}
[data-testid="stFormSubmitButton"] button *,
[data-testid="stButton"] button *{
  color:#ffffff !important;
