...
/* Force Streamlit widget text to remain readable on the light app background,
   even when the viewer/browser prefers dark mode. */
...
div[data-testid="stSlider"] label, div[data-testid="stSlider"] label p {color:#172334 !important;}

/* Inputs and select boxes */
div[data-testid="stNumberInput"] input,
div[data-testid="stTextInput"] input {background:#ffffff !important;color:#172334 !important;-webkit-text-fill-color:#172334 !important;}
div[data-testid="stNumberInput"] button {color:#172334 !important;background:#ffffff !important;}
div[data-testid="stSelectbox"] [data-baseweb="select"] > div {background:#ffffff !important;color:#172334 !important;}
div[data-testid="stSelectbox"] [data-baseweb="select"] span,
div[data-testid="stSelectbox"] [data-baseweb="select"] div {color:#172334 !important;}

/* Captions, help text, expanders and tabs */
[data-testid="stCaptionContainer"], [data-testid="stCaptionContainer"] p {color:#667085 !important;}
[data-testid="stExpander"] summary, [data-testid="stExpander"] summary p {color:#172334 !important;}
button[data-baseweb="tab"], button[data-baseweb="tab"] p {color:#425466 !important;}
button[data-baseweb="tab"][aria-selected="true"], button[data-baseweb="tab"][aria-selected="true"] p {color:#0c2d4d !important;font-weight:750;}

/* Keep section headings readable while preserving the white hero text. */
...
[data-testid="stAppViewContainer"] h4:not(.hero h4) {color:#172334;}
