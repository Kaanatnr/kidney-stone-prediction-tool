...
.hero h1{margin:0 0 10px;font-size:42px;line-height:1.05;letter-spacing:-.025em}.hero p{margin:0;opacity:1;max-width:900px;line-height:1.6;font-size:15px;color:#ffffff !important}
...
<style>
/* ----- theme fix v3 ----- */
.hero p, .hero h1, .hero .badge, .hero .metric, .hero .metric *, .hero *{
  color:#ffffff !important;
}

/* Blue select boxes with white text */
...
/* Opened dropdown menu in same blue family */
div[role="listbox"], ul[role="listbox"], li[role="option"], li[role="option"] * {
...
/* Help icons blue with white question mark */
...
div[role="tooltip"], div[data-baseweb="popover"] > div {
  background:#145d86 !important;
